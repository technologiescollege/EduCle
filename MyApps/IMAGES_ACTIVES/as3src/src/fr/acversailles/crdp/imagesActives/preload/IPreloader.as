...
package fr.acversailles.crdp.imagesActives.preload {
	 ...
	 */
	public interface IPreloader extends ISprite {
		function afficherProgression(valeur : Number) : void;

		function afficherNouvelleRessource(numero : Number, total : Number) : void;
