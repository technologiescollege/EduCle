...
package fr.acversailles.crdp.imagesActives.infos {
	 ...
	 */
	public interface IZoneInfosDroits extends ISprite {
		function souleverLegerement() : void;
		function replacer() : void;

		function set yDepart(yDepart : Number) : void

		function get etat() : uint;

		function sortir() : void;

		function descendreHorsEcran() : void;
	}
}
