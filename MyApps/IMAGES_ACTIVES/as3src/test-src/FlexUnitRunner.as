package {
	import testParseurSVGSuite.TestParseurSVGSuite;
	import testAnalyseurLiensSuite.TestAnalyseursLiensSuite;
	...
	public class FlexUnitRunner extends Sprite {
		...
		public function FlexUnitRunner() {
			...
			//core.run( request );
			core.run(TestAnalyseursLiensSuite, TestParseurSVGSuite);
		}
	}
}
