package com.lorentz.SVG {
	...
	public class SVGParserCommon {
		 ...
		 * Ajouté par moi
		 */
		public static function parseMetadata(elt : XML) : Object {
			var result:Object = {};
			//TODO regrouper les namespaces quelquepart
			var rdf:Namespace = new Namespace("http://www.w3.org/1999/02/22-rdf-syntax-ns#");
			var cc:Namespace = new Namespace("http://creativecommons.org/ns#");
			var dc:Namespace = new Namespace("http://purl.org/dc/elements/1.1/");
			result['title']=elt.rdf::RDF.cc::Work.dc::title.text();
			result['source']=elt.rdf::RDF.cc::Work.dc::source.text();
			result['infos']=elt.rdf::RDF.cc::Work.dc::description.text();
			//ajout
			result['rights']=elt.rdf::RDF.cc::Work.dc::rights.cc::Agent.dc::title.text();
			result['creator']=elt.rdf::RDF.cc::Work.dc::creator.cc::Agent.dc::title.text();
			result['date']=elt.rdf::RDF.cc::Work.dc::date.text();
			return result;
		}
