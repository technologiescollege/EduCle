package com.lorentz.SVG.display {
	...
	public class SVGElement extends Sprite implements IDocumentSetable {
		...
		protected var _finalStyle : Object;

		// After inherit parent styles
		...
		protected function inheritStyles() : void {
			if (_parentElement) {
				_finalStyle = _parentElement._finalStyle;
				// Inherits parent style
			} else {
				_finalStyle = {};
			}

			if (document.styles[type] != null) {
		...
		protected function beginFill(g : Graphics = null) : void {
			...
			if (fill_str == "" || fill_str == "none") {
				...
				if (fill_str == null) {
					g.beginFill(0x000000, fill_opacity);
					// Initial value to fill is black
		...
		/**
		 * ajouts pour Images Actives
		 */
		public function get zoomable() : Boolean {
			return _zoomable;
		}
		
		public function get puce() : Boolean {
			return _puce;
		}
		

		public function set zoomable(zoomable : Boolean) : void {
			_zoomable = zoomable;
		}
		
		public function set puce(puce : Boolean) : void {
			_puce = puce;
		}
