...
"y!";
      ...
      this.label25.Text = "The Rasterbator Standalone 1.2 - Matias Ärje 2005 - rasterbator@arje.net - Licenc" +
"ed under GPL";
      // 
      // ContinueButton5
      // 
      ...
      CustomColorRadio.Checked=true;
		...
		void Button9Click(object sender, System.EventArgs e)
		{
		  ...
		  S["WorkDirectory"]=textBox2.Text.Substring(0, textBox2.Text.LastIndexOf("\\")+1);
