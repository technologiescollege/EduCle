	...
	jQuery.fn.ubwbutton = function(size, arrows) {
			...
			return this.each(function() {
				...
				var buttonCanvas = $("<div></div>")
					...
					//.html('<table width="auto" height="auto" cellpadding="0" cellspacing="0"><tr><td class="ubw-button-arrowTop" align="center"><img style="margin-bottom:-12px; z-index:1; position:relative" src="images/arrows_over/top.png"></td></tr><tr><td><table width="auto" height="auto" border="0" cellpadding="0" cellspacing="0"><tr><td class="ubw-button-arrowLeft"><img style="margin-right:-1px" src="images/arrows_out/left.png"></td><td class="ubw-button-body"></td><td class="ubw-button-arrowRight"><img style="margin-left:-1px" src="images/arrows_out/right.png"></td></tr></table></td></tr><tr><td class="ubw-button-arrowBottom" align="center"><img style="margin-top:-12px; z-index:1; position:relative" src="images/arrows_over/bottom.png"></td></tr></table>');
